...
// Must extend PreOrderMappableContainer<Data>, PostOrderMappableContainer<Data>
...
template <typename Data>
class SortableLinearContainer : virtual public LinearContainer<Data>{ // Must extend LinearContainer<Data>
...
public:
  ...
  // Comparison operators
  bool operator==(const SortableLinearContainer&) const; // Comparison of abstract types is possible.
  bool operator!=(const SortableLinearContainer&) const; // Comparison of abstract types is possible.
